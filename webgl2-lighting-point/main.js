...
function drawScene(gl, program, vao, uniforms, data) {
    ...
    gl.uniform3fv(uniforms.u_lightWorldPosition, data.lightSourcePosition)
...
async function main() {
    ...
    webglUtils.setupSliders({
        ...
        "Light source x: ": {
            ...
            maxValue: 120,
            stepValue: 1,
            currentValue: data.lightSourcePosition[0],
            handle: number_converter('lightSourcePosition')(0)
        },
        "Light source y: ": {
            minValue: -120,
            maxValue: 120,
            stepValue: 1,
            currentValue: data.lightSourcePosition[1],
            handle: number_converter('lightSourcePosition')(1)
        },
        "Light source z: ": {
            minValue: -120,
            maxValue: 120,
